          ...
          >
            <CardContent style={{ padding: theme.spacing(4) }}>
              ...
              <Typography variant="body1">
                ...
                project.The division is meant to be intuitive and user friendly,
                its made for curious explorers and creators, not scientists!
                Help us co-create bio-based future!
              </Typography>
            </CardContent>
          </Card>
        </Grid>
