          ...
          >
            <Box m={0} p={2} borderTop={0} className={classes.boxTop}>
              ...
              <Typography variant="body1">
                ...
                eligendi possimus quo aliquid explicabo quos voluptatem sit vel
                maxime nostrum consequatur delectus earum similique, quod
                excepturi perspiciatis nisi! Possimus commodi, aspernatur
                eligendi porro aut incidunt expedita blanditiis quis ducimus
                repellat, aliquid explicabo quisquam obcaecati architecto! Quis
                assumenda cumque nulla dolores voluptate quisquam quam.
              </Typography>
            </Box>
            <Box m={0} p={2} borderTop={0} className={classes.boxTop}>
              <Typography variant="h3" component="h2">
